...
const CREDITS = [
    {
        title: 'Design, Modeling and Texturing',
        rows: [['Abhishek Pandey','All']],
    },
 
    {
        title: 'Sound Design',
        rows: [
            ['Abhishek Pandey', 'Mixing, Composition, & Foley'],
...
const Credits: React.FC<CreditsProps> = (props) => {
    ...
    return (
        ...
        >
            ...
            >
                <h2>Credits</h2>
                <p>abhishekpxndy.vercel.app, 2022</p>
                <br />
                <br />
                <br />
