...
const Window: React.FC<WindowProps> = (props) => {
    ...
    const [isMaximized, setIsMaximized] = useState(props.startMaximized || false);
    ...
    return (
        <div onMouseDown={onWindowInteract} style={styles.container}>
            <div
                ...
                ref={windowRef}
            >
                <div style={Object.assign({}, styles.windowBorderOuter, isMaximized && { border: 'none' })}>
                    <div style={Object.assign({}, styles.windowBorderInner, isMaximized && { border: 'none', padding: 0 })}>
                        {!isMaximized && (
                            <div
