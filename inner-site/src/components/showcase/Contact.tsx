        ...
        <div className="site-page-content">
            <div style={styles.header}>
                ...
                <div style={styles.socials}>
                    <SocialBox
                        icon={ghIcon}
                        link={'https://github.com/abhishekpxndy'}
                    />
                    <SocialBox
                        icon={inIcon}
                        link={'https://www.linkedin.com/in/abhishek-pandey-3a28381a5/'}
                    />
                    <SocialBox
                        icon={twitterIcon}
                        link={'https://x.com/abhishekpxndy'}
                    />
                </div>
            </div>
            <div className="text-block">
                <p>
                    I am currently unemployed, if you have any
